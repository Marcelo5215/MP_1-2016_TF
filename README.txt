Instruções de compilação:
	Supondo o diretório fonte, onde está esse arquivo:
...
./gui é o programa cominterface gráfica (Algumas funções ainda não estão disponíveis)
./test realiza os testes em cima de algumas funções 
